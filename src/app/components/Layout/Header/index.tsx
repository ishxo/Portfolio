...
const Header: React.FC = () => {
  ...
  return (
    <header className={`fixed top-0 z-50 w-full bg-transparent transition-all ${sticky ? "shadow-lg dark:shadow-neutral-50/5 bg-white dark:bg-darklight" : "shadow-none"}`}>
      <div className={`container flex items-center justify-between gap-10 duration-300 ${sticky ? "py-3" : "py-4"}`}>
        <Logo />
        <nav>
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <Icon icon="solar:sun-2-bold" width="24" height="24" className="hidden dark:block" />
            <Icon icon="solar:moon-bold" width="24" height="24" className="dark:hidden block" />
          </button>
