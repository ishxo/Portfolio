...
const Project = () => {
  ...
  const PrevArrow = ({ onClick }: { onClick?: () => void }) => (
    <button
      className="hidden md:flex items-center justify-center absolute top-1/2 transform -translate-y-1/2 left-[-50px] z-30 w-10 h-10 rounded-full
  ...
  const NextArrow = ({ onClick }: { onClick?: () => void }) => (
    <button
      className="hidden md:flex items-center justify-center absolute top-1/2 transform -translate-y-1/2 right-[-50px] z-30 w-10 h-10 rounded-full
                 bg-white/80 text-blue-600 hover:bg-white hover:text-blue-700
                 dark:bg-gray-700 dark:text-gray-400 dark:hover:bg-gray-600"
      onClick={onClick}
    >
